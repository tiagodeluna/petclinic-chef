...
remote_file '/opt/tomcat_petclinicserver_8_0_36/webapps/petclinic.war' do
	source 'http://localhost:8081/artifactory/webapp/#/artifacts/browse/tree/General/libs-snapshot-local/org/springframework/samples/spring-petclinic/1.0.2-SNAPSHOT/spring-petclinic-1.0.2-20180417.222408-1.war'
